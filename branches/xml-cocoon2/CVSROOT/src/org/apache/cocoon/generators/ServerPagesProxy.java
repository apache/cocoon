...
import org.apache.cocoon.components.serverpages.ServerPagesLoader;
...
/**
 * This class acts as a proxy to a dynamically loaded
 * <code>ServerPagesGenerator</code> delegating actual SAX event generation.
 *
 * @author <a href="mailto:ricardo@apache.org">Ricardo Rocha</a>
 * @version CVS $Revision: 1.1.2.1 $ $Date: 2000-05-23 23:10:11 $
 */
public class ServerPagesProxy
  extends ComposerGenerator
  implements ContentHandler, LexicalHandler
{
  /**
   * The sitemap-defined server pages loader
   */
  protected static ServerPagesLoader loader = null;
  ...
  public void setComponentManager(ComponentManager manager) {
    ...
    if (loader == null) {
      loader =
        (ServerPagesLoader) this.manager.getComponent("serverpages-loader");
    }
  }
  ...
  public void generate() throws IOException, SAXException, ProcessingException {
    ...
    try {
      generator = loader.load(file, markupLanguage, programmingLanguage);
    } catch (Exception e) {
e.printStackTrace();
