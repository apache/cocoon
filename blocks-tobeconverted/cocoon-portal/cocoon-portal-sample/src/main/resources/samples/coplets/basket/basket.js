...
function result() {
    ...
    var item = new Packages.org.apache.cocoon.portal.coplets.basket.ContentItem("cocoon://samples/blocks/portal-sample/coplets/basket/copletwithappresult.showresult.flow", true);
    var event = new Packages.org.apache.cocoon.portal.coplets.basket.events.AddItemEvent(store, item);
