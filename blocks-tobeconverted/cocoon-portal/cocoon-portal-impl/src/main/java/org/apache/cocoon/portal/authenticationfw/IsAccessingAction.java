 ...
 * @version $Id$
 */
public final class IsAccessingAction
    ...
    throws Exception {
        if (this.getLogger().isDebugEnabled() ) {
            this.getLogger().debug("Portal is-accessing action called.");
        }

        PortalUser user = User.getPortalUser(this.manager, this.portalService.getPortalName());
        UserEventUtil.sendUserIsAccessingEvent(this.portalService, user);
