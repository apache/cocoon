...
/** 
* <strong>Internal use only</strong>: this class is a copy of
* <code>org.xml.sax.helpers.NamespaceSupport</code> to workaround
* an annoying but that has been fixed in a yet-not-released version.
* <p>
*
