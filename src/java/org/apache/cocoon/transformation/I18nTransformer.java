...
public class I18nTransformer extends AbstractTransformer
    ...
    throws SAXException {
        ...
        if (I18N_TEXT_ELEMENT.equals(name)) {
            ...
            if (currentKey == null) {
                ...
                currentKey = attr.getValue(I18nTransformer.I18N_NAMESPACE_URI, I18N_KEY_ATTRIBUTE);
                if (currentKey == null) {
                    // Try the old namespace
                    currentKey = attr.getValue(I18nTransformer.I18N_OLD_NAMESPACE_URI, I18N_KEY_ATTRIBUTE);
                }
            }
            ...
            if (currentCatalogueId == null) {
                // Try the namespaced attribute
                currentCatalogueId = attr.getValue(I18nTransformer.I18N_NAMESPACE_URI, I18N_CATALOGUE_ATTRIBUTE);
            }
    ...
    throws SAXException {
        ...
        int attrIndex = attr.getIndex(I18nTransformer.I18N_NAMESPACE_URI, I18N_ATTR_ATTRIBUTE);
        if (attrIndex == -1) {
            // Try the old namespace
            attrIndex = attr.getIndex(I18nTransformer.I18N_OLD_NAMESPACE_URI, I18N_ATTR_ATTRIBUTE);
        }
        ...
        // using their values as keys.
        attrIndex = attr.getIndex(I18nTransformer.I18N_NAMESPACE_URI, I18N_EXPR_ATTRIBUTE);
        if (attrIndex != -1) {
            StringTokenizer st = new StringTokenizer(attr.getValue(attrIndex));
