    ...
    extends HtmlUnitTestCase
{
        ...
        throws Exception
    {
        ...
        assertXPath("normalize-space(/html/body/div[1]/p[1])", "First paragraph of the test document.");
        assertXPath("normalize-space(/html/body/div[3])", "Presentation generated by the plain-template.xml XSLTAL template.");
    }
}
