 ...
 */
dojo.provide("cocoon.forms.TimeField");

dojo.require("dijit.form.TimeTextBox");
dojo.require("cocoon.forms._FieldMixin");

/**
 * CForms TimeField Widget.
 * A field that validates time in different locales        
 *
 * NB. The current dijit.form.TimeTextBox works inconsistently accross Browsers
 *     Safari is fine, Firefox is pants 
 *
 ...
 * @version $Id$
 */
dojo.declare("cocoon.forms.TimeField", [dijit.form.TimeTextBox, cocoon.forms._FormattingFieldMixin, cocoon.forms._SizedFieldMixin], {	
