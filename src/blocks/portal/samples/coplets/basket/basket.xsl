<?xml version="1.0"?>
<!-- $Id: basket.xsl,v 1.1 2004/02/23 14:52:49 cziegeler Exp $ 
...
<h1>Your Basket</h1>
<p>You have <xsl:value-of select="item-count"/> items in your basket. <a href="{persist-url}">Persist Basket</a>.</p>
