...
public class ServletProtocol extends HtmlUnitTestCase {
    ...
    public void testSimplePipeline() throws Exception {
        this.loadXmlPage("cocoon-servlet-service-sample1/test");
