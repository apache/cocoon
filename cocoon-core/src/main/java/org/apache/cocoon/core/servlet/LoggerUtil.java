...
/**
 * This is an utility class to create a new Logger instance. It is
 * is based on the logging parts of o.a.c.core.CoreUtil, but uses
 * a ServletContext instead of a BootstrapEnvironment. It is not tested
 * to any extent yet.
 * 
